      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th width="70%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending">Ime Rase</th>
            ...
            <tbody>
                ...
                <tr role="row" class="odd">
                  <td>{{ $sort->name}}</td>
                  <td>
                    <form class="row" method="POST" action="{{ route('sorts.destroy', ['id' => $sort->id]) }}" onsubmit = "return confirm('Are you sure?')">
           ...
           @endif
            <tfoot>
              <tr>
                <th width="20%" rowspan="1" colspan="1">Ime Rase</th>
