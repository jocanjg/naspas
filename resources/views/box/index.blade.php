  ...
  <div class="box-header">
    <div class="row">
        <div class="col-sm-8">
          ...
          <p>Unesi novi kavez ili ukloni postojeći</p>
        </div>
        <div class="col-sm-4">
          <a class="btn btn-primary" href="{{ route('box.create') }}">Dodaj novi</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
            ...
            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              ...
              <tbody>
                  ...
                  <tr role="row" class="odd">
                    <td>{{ $box->name}}</td>
                    <td>
                      <form class="row" method="POST" action="{{ route('box.destroy', ['id' => $box->id]) }}" onsubmit = "return confirm('Are you sure?')">
