...
|---------------------------------------------------------|
-->
<body class="skin-purple hold-transition sidebar-collapse" style="bakcground-color: #ecf0f5;">
<div class="wrapper">
...
@foreach ($animals as $animal)
    <div class="col-md-4">
      ...
      <div class="box box-widget widget-user">
        ...
        <div class="widget-user-header bg-aqua-active" style="background-image: url({{ asset('storage/'.$animal->picture) }}); background-repeat: no-repeat; background-size: cover; background-position: center center; height: 385px;">
